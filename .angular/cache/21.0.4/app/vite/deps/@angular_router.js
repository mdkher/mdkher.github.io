import { Title } from "./chunk-I667DJCI.js";
import {
...
import { defer, isObservable } from "./chunk-HWYXSU2G.js";
...
var ApplyRedirects$1 = class ApplyRedirects {
  ...
  async applyRedirectCommands(
    ...
    const redirect = await getRedirectResult$1(
      redirectTo,
      currentSnapshot,
      injector,
    );
...
This is currently a dev mode only error but will become a call stack size exceeded error in production in a future major version.`,
    ...
    const newSegments = await this.applyRedirects.lineralizeSegments(
      route,
      newTree,
    );
  ...
  async matchSegmentAgainstRoute(
    ...
    const { routes: childConfig } = await this.getChildConfig(
      injector,
      route,
      segments,
    );

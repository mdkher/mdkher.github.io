import { Component, ChangeDetectionStrategy, ElementRef, ViewChild, AfterViewInit, PLATFORM_ID, inject, OnDestroy } from '@angular/core';
...
export class ProcessComponent implements AfterViewInit, OnDestroy {
    ...
    steps = [
        { title: 'Discovery', desc: 'Decoding constraints & user needs.', icon: '01' },
        { title: 'Architect', desc: 'Wireframing low-fidelity schematics.', icon: '02' },
        { title: 'Develop', desc: 'High-fidelity UI & Interaction code.', icon: '03' },

...
export const SKILLS_DATA: string[] = [
  'ANGULAR', 'FIGMA', 'TYPESCRIPT', 'VIBE CODING', 'UX DESIGN', 'DESIGN SYSTEMS', 'UX RESEARCH', 'PROTOTYPING', 'STORYBOOK', 'ACCESSIBILITY'
];

export const CLIENTS_DATA: string[] = [
  'Samsung', 'Airtable', 'Facebook', 'Globant', 'Infosys'
];
...
export const PROJECTS_DATA: Project[] = [
  {
    ...
    description: 'As a Product Designer, I led the initiative to build and enhance a scalable design system that streamlined workflows, improved UI consistency, and empowered designers and developers to work efficiently.',
    ...
    problemStatement: 'Before the design system, the product faced inconsistent UI patterns across different features, time-consuming handoffs between designers and developers, a lack of accessibility standards, and no unified documentation.',
    contextText: [
      ...
      'The organization faced fragmented UI consistency. Teams were reinventing the wheel, accessibility was an afterthought, and design debt was slowing down feature releases.'
    ],
    researchFindings: [
      { icon: '🔍', title: 'Inconsistency', desc: 'Identified inconsistent UI patterns across different features through a UI audit.' },
      { icon: '♿', title: 'Accessibility Gap', desc: 'Lack of accessibility standards leading to usability concerns (WCAG 2.1).' },
      { icon: '⏱️', title: 'Hand-off Friction', desc: 'Time-consuming handoffs between designers and developers without unified documentation.' }
    ],
    researchGraph: [
    ...
    process: [
      { title: 'Research & Audit', description: 'Conducted a UI audit and researched industry best practices (Material UI, IBM Carbon).' },
      { title: 'Component Library', description: 'Designed atomic-level components with variants and auto-layout in Figma.' },
      { title: 'Collaboration', description: 'Partnered with developers to build a Storybook-based UI component library using React/Angular.' },
      { title: 'Documentation', description: 'Created detailed guidelines in Figma and established a feedback loop for continuous improvements.' }
    ],
    designSystem: {
      colors: [
    ...
    solution: 'Established a scalable, reusable component library aligned with the front-end framework for both Desktop and Mobile.',
    solutionText: [
    ...
    governanceModel: {
      ...
      description: 'Versioning and governance were established to help keep the design system scalable and maintainable. Regular updates and a feedback loop ensured that the system evolved with the product needs. Early developer collaboration prevented friction during implementation, addressing the issue where developer versions often lagged behind design files.',
      imageUrl: 'https://picsum.photos/id/10/800/600'
    },
    keyFeatures: [
      { title: 'Atomic Components', desc: 'Designed atomic-level components (buttons, inputs, tables) with variants for flexible usage.', image: 'https://picsum.photos/id/1/800/600' },
      { title: 'Accessibility First', desc: 'Achieved AA compliance (WCAG 2.1) for the majority of core components.', image: 'https://picsum.photos/id/119/800/600' }
    ],
    stats: [
      { value: '400k+', label: 'Weekly Inserts', description: 'Used across 360 teams' },
      { value: '40%', label: 'Reduced Debt', description: 'Eliminating inconsistencies' },
      { value: '30%', label: 'Faster Handoff', description: 'For new features' }
    ],
    businessImpact: [
  ...
  },
  {
    ...
    description: 'Spearheaded the AR initiative at Globant, evolving a personal experiment into a dedicated "AR Pod" and delivering viral experiences with 10k+ views.',
    ...
    problemStatement: 'AR was an untapped opportunity at Globant with no structured team or frameworks. The challenge was to demonstrate the value of AR for engagement and product innovation from scratch.',
    contextText: [
    ...
    researchFindings: [
      { icon: '🚀', title: 'Untapped Market', desc: 'Zero existing AR projects or teams within the organization.' },
      { icon: '📱', title: 'Engagement Gap', desc: 'Traditional digital campaigns were seeing diminishing returns in user interaction.' },
      { icon: '🎓', title: 'Skill Void', desc: 'Designers flocked to learn 3D/AR but lacked mentorship or structured learning paths.' }
    ],
    researchGraph: [
    ...
    process: [
      { title: 'Concept', description: 'Conducted AR tech audits and created proof-of-concepts.' },
      { title: '3D Creation', description: 'Modeled low-poly assets in Blender and scanned real-world environments.' },
      { title: 'Logic', description: 'Developed gesture-based controls and gamification in Spark AR.' },
      { title: 'Deployment', description: 'Launched filters at DesignNXT and hosted internal workshops.' }
    ],
    designSystem: {
      colors: [
    ...
    solution: 'I established the "AR Pod," a dedicated innovation unit for spatial computing.',
    solutionText: [
    ...
    governanceModel: {
      ...
      description: 'To move from "hackathon ideas" to "client deliverables," I established a pipeline for AR projects. This included a repository of optimized 3D assets, standard scripts for common interactions (like tap-to-place), and a review process for performance optimization on mobile devices.',
      imageUrl: 'https://picsum.photos/id/30/800/600'
    },
    keyFeatures: [
      { title: 'Gamified Filters', desc: 'Quiz-based logic and gesture controls that drove high engagement.', image: 'https://picsum.photos/id/24/800/600' },
      { title: 'Real-World Mapping', desc: 'Seamless integration of digital objects into physical spaces.', image: 'https://picsum.photos/id/35/800/600' }
    ],
    stats: [
      { value: '10k+', label: 'Views', description: 'On Instagram Filters' },
      { value: '1st', label: 'Internal Team', description: 'Established AR Pod' },
      { value: '100%', label: 'Adoption', description: 'Company-wide recognition' }
    ],
    businessImpact: [
  ...
  },
  {
    ...
    description: 'Redesigned the internal employee travel platform with enhanced micro-interactions, reducing booking time by 20%.',
    ...
    problemStatement: 'The internal travel booking application faced complex workflows, lack of intuitive components, and minimal interactivity, making the platform feel static and tedious for thousands of employees.',
    contextText: [
    ...
    researchFindings: [
      { icon: '⚠️', title: 'Complex Workflows', desc: 'Booking flows were tedious and approval processes required multiple disjointed steps.' },
      { icon: '🖱️', title: 'Static UI', desc: 'Lack of visual feedback left users unsure if their actions were registered.' },
      { icon: '📱', title: 'Mobile Friction', desc: 'The experience was not optimized for mobile, creating blockers for approvals on-the-go.' }
    ],
    researchGraph: [
    ...
    process: [
      { title: 'UX Audit', description: 'Analyzed existing flows and compared with consumer travel standards (Expedia, Skyscanner).' },
      { title: 'Refinement', description: 'Redesigned UI components for better intuitiveness (search filters, date pickers).' },
      { title: 'Motion', description: 'Implemented hover states, loading effects, and feedback animations.' },
      { title: 'Optimization', description: 'Ensured seamless experience across both mobile and desktop.' }
    ],
    designSystem: {
      colors: [
    ...
    solution: 'A "Glow-up" for the enterprise travel experience, focusing on micro-interactions.',
    solutionText: [
    ...
    governanceModel: {
      ...
      description: 'To ensure performance wasn\'t compromised by "flashy" animations, I defined strict motion guidelines. Animations were purely functional—used to indicate state changes, loading progress, or confirmation—never just for decoration.',
      imageUrl: 'https://picsum.photos/id/48/800/600'
    },
    keyFeatures: [
      { title: 'Micro-Interactions', desc: 'Subtle hover effects and state changes that provide immediate system feedback.', image: 'https://picsum.photos/id/60/800/600' },
      { title: 'One-Click Approvals', desc: 'Streamlined workflow for managers to approve trips instantly from mobile.', image: 'https://picsum.photos/id/20/800/600' }
    ],
    stats: [
      { value: '20%', label: 'Efficiency', description: 'Reduction in booking time' },
      { value: 'Mobile', label: 'Optimization', description: 'Seamless cross-device use' },
      { value: 'High', label: 'Engagement', description: 'Increased platform adoption' }
    ],
    businessImpact: [
  ...
  },
  {
    ...
    description: 'A conceptual metaverse experience for car servicing, increasing trust and transparency for non-technical users.',
    ...
    problemStatement: 'Car owners, especially those with limited automotive knowledge, often feel anxious and excluded during the servicing process due to lack of clarity, technical jargon, and information asymmetry regarding costs and parts.',
    contextText: [
    ...
    researchFindings: [
      { icon: '⚠️', title: 'Trust Deficit', desc: 'Users felt "blind" to what was actually happening to their car behind closed doors.' },
      { icon: '💸', title: 'Cost Anxiety', desc: 'Unclear why certain parts cost what they did, leading to suspicion of overcharging.' },
      { icon: '🔧', title: 'Jargon Barrier', desc: 'Mechanics used technical terms that alienated non-expert users.' }
    ],
    researchGraph: [
    ...
    process: [
      { title: 'Discovery', description: 'Conducted interviews with underserved user segments to identify trust gaps.' },
      { title: 'Ideation', description: 'Mapped the ideal "transparent" journey using a Metaverse Service Center concept.' },
      { title: 'Prototyping', description: 'Built 3D service visualization flows where users could specific parts being replaced.' },
      { title: 'Validation', description: 'Tested the concept with users, receiving high praise for clarity and control.' }
    ],
    designSystem: {
      colors: [
    ...
    solution: 'A "Metaverse Garage" that visualizes the servicing process in real-time.',
    solutionText: [
    ...
    governanceModel: {
      ...
      description: 'To ensure the metaverse experience wasn\'t just a gimmick, I established an ethical framework. The system was designed to never "upsell" unnecessarily; it was purely informational. Every visual notification had to be tied to a verified service action.',
      imageUrl: 'https://picsum.photos/id/111/800/600'
    },
    keyFeatures: [
      { title: 'Live Digital Twin', desc: 'Real-time 3D visualization of the car servicing status.', image: 'https://picsum.photos/id/133/800/600' },
      { title: 'Visual Receipts', desc: 'Interactive breakdown of costs where users can click parts to see warranty info.', image: 'https://picsum.photos/id/160/800/600' }
    ],
    stats: [
      { value: 'High', label: 'Trust Score', description: 'From user testing' },
      { value: '100%', label: 'Transparency', description: 'Real-time updates' },

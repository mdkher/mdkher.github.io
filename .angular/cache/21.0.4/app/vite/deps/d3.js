...
function Blur2(blur3) {
  return function (data, rx, ry = rx) {
    ...
    if (
      !(
        (height = Math.floor(
          height !== void 0 ? height : values.length / width,
        )) >= 0
      )
    )
...
function blurf(radius) {
  ...
  return (T, S, start2, stop, step) => {
    ...
    for (let i = start2, j = stop; i <= j; i += step) {
      ...
      T[i] =
        (sum4 + t * (S[Math.max(start2, i - s1)] + S[Math.min(stop, i + s1)])) /
        w;
...
function cumsum(values, valueof) {
  ...
  return Float64Array.from(
    ...
    valueof === void 0
      ? (v2) => (sum4 += +v2 || 0)
      : (v2) => (sum4 += +valueof(v2, index3++, values) || 0),
  );
}
...
function fcumsum(values, valueof) {
  ...
  return Float64Array.from(
    ...
    valueof === void 0
      ? (v2) => adder.add(+v2 || 0)
      : (v2) => adder.add(+valueof(v2, ++index3, values) || 0),
  );
}
...
function groupSort(values, reduce2, key) {
  return (
    reduce2.length !== 2
      ...
      : sort(
          group(values, key),
          ([ak, av], [bk, bv]) => reduce2(av, bv) || ascending(ak, bk),
        )
  ).map(([key2]) => key2);
}
...
function ticks(start2, stop, count3) {
  ...
  const reverse2 = stop < start2,
    [i1, i2, inc2] = reverse2
      ? tickSpec(stop, start2, count3)
      : tickSpec(start2, stop, count3);
  if (!(i2 >= i1)) return [];
  const n = i2 - i1 + 1,
    ticks2 = new Array(n);
  if (reverse2) {
...
function tickStep(start2, stop, count3) {
  ...
  const reverse2 = stop < start2,
    inc2 = reverse2
      ? tickIncrement(stop, start2, count3)
      : tickIncrement(start2, stop, count3);
  ...
  histogram.thresholds = function (_) {
    return arguments.length
      ? ((threshold2 =
          typeof _ === "function"
            ? _
            : constant(Array.isArray(_) ? slice.call(_) : _)),
        histogram)
      : threshold2;
  };
  return histogram;
...
function min(values, valueof) {
  ...
  if (valueof === void 0) {
    for (const value of values) {
      if (
        value != null &&
        (min4 > value || (min4 === void 0 && value >= value))
      ) {
        min4 = value;
      }
    }
...
function quickselect(array4, k2, left2 = 0, right2 = Infinity, compare) {
  ...
  while (right2 > left2) {
    if (right2 - left2 > 600) {
      ...
      const sd =
        0.5 * Math.sqrt((z * s2 * (n - s2)) / n) * (m3 - n / 2 < 0 ? -1 : 1);
      const newLeft = Math.max(left2, Math.floor(k2 - (m3 * s2) / n + sd));
      const newRight = Math.min(
        right2,
        Math.floor(k2 + ((n - m3) * s2) / n + sd),
      );
...
function quantileIndex(values, p, valueof = number) {
  if (isNaN((p = +p))) return;
  numbers2 = Float64Array.from(values, (_, i2) =>
    number(valueof(values[i2], i2, values)),
  );
  if (p <= 0) return minIndex(numbers2);
  if (p >= 1) return maxIndex(numbers2);
  var numbers2,
    index3 = Uint32Array.from(values, (_, i2) => i2),
    j = numbers2.length - 1,
    i = Math.floor(j * p);
  quickselect(index3, i, 0, j, (i2, j2) =>
    ascendingDefined(numbers2[i2], numbers2[j2]),
  );
...
function thresholdFreedmanDiaconis(values, min4, max5) {
  const c6 = count(values),
    d = quantile(values, 0.75) - quantile(values, 0.25);
  return c6 && d
    ? Math.ceil((max5 - min4) / (2 * d * Math.pow(c6, -1 / 3)))
    : 1;
}
...
function transpose(matrix) {
  ...
  for (
    var i = -1, m3 = min(matrix, length2), transpose2 = new Array(m3);
    ++i < m3;
  ) {
...
function axis(orient, scale2) {
  ...
  function axis2(context) {
    var values =
        tickValues == null
          ? scale2.ticks
            ? scale2.ticks.apply(scale2, tickArguments)
            : scale2.domain()
          : tickValues,
      format2 =
        tickFormat2 == null
          ? scale2.tickFormat
            ? scale2.tickFormat.apply(scale2, tickArguments)
            : identity_default
          : tickFormat2,
      spacing = Math.max(tickSizeInner, 0) + tickPadding,
      range4 = scale2.range(),
      range0 = +range4[0] + offset,
      range1 = +range4[range4.length - 1] + offset,
      position = (scale2.bandwidth ? center : number2)(scale2.copy(), offset),
      selection2 = context.selection ? context.selection() : context,
      path2 = selection2.selectAll(".domain").data([null]),
      tick = selection2.selectAll(".tick").data(values, scale2).order(),
      tickExit = tick.exit(),
...
function order_default() {
  for (var groups2 = this._groups, j = -1, m3 = groups2.length; ++j < m3; ) {
    for (
      var group2 = groups2[j], i = group2.length - 1, next = group2[i], node;
      --i >= 0;
    ) {
      if ((node = group2[i])) {
...
function styleValue(node, name) {
  return (
    ...
    window_default(node).getComputedStyle(node, null).getPropertyValue(name)
  );
}
...
function selectAll_default2(selector) {
  return typeof selector === "string"
    ...
    : new Selection([array2(selector)], root);
}
...
function nodrag_default(view) {
  var root3 = view.document.documentElement,
    selection2 = select_default2(view).on(
      "dragstart.drag",
      noevent_default,
      nonpassivecapture,
    );
...
function drag_default() {
  ...
  drag.filter = function (_) {
    return arguments.length
      ? ((filter3 = typeof _ === "function" ? _ : constant_default2(!!_)), drag)
      : filter3;
  };
  drag.container = function (_) {
    return arguments.length
      ? ((container = typeof _ === "function" ? _ : constant_default2(_)), drag)
      : container;
  };
  drag.subject = function (_) {
    return arguments.length
      ? ((subject = typeof _ === "function" ? _ : constant_default2(_)), drag)
      : subject;
  };
  drag.touchable = function (_) {
    return arguments.length
      ? ((touchable = typeof _ === "function" ? _ : constant_default2(!!_)),
        drag)
      : touchable;
  };
  drag.on = function () {
        ...
        : l === 3
          ...
          : l === 8
            ...
            : l === 4
              ...
              : null)
    : (m3 = reRgbInteger.exec(format2))
      ? new Rgb(m3[1], m3[2], m3[3], 1)
      : (m3 = reRgbPercent.exec(format2))
        ? new Rgb(
            (m3[1] * 255) / 100,
            (m3[2] * 255) / 100,
            (m3[3] * 255) / 100,
        ...
        : (m3 = reRgbaInteger.exec(format2))
          ? rgba(m3[1], m3[2], m3[3], m3[4])
          : (m3 = reRgbaPercent.exec(format2))
            ? rgba(
                (m3[1] * 255) / 100,
                (m3[2] * 255) / 100,
                (m3[3] * 255) / 100,
            ...
            : (m3 = reHslPercent.exec(format2))
              ? hsla(m3[1], m3[2] / 100, m3[3] / 100, 1)
              : (m3 = reHslaPercent.exec(format2))
                ? hsla(m3[1], m3[2] / 100, m3[3] / 100, m3[4])
...
function lab(l, a4, b, opacity) {
  return arguments.length === 1
    ? labConvert(l)
    : new Lab(l, a4, b, opacity == null ? 1 : opacity);
}
function Lab(l, a4, b, opacity) {
  this.l = +l;
  this.a = +a4;
...
function lrgb2rgb(x4) {
  return (
    255 * (x4 <= 31308e-7 ? 12.92 * x4 : 1.055 * Math.pow(x4, 1 / 2.4) - 0.055)
  );
}
function rgb2lrgb(x4) {
  return (x4 /= 255) <= 0.04045
    ? x4 / 12.92
    : Math.pow((x4 + 0.055) / 1.055, 2.4);
}
...
function lch(l, c6, h, opacity) {
  return arguments.length === 1
    ? hclConvert(l)
    : new Hcl(h, c6, l, opacity == null ? 1 : opacity);
}
...
function cubehelix(h, s2, l, opacity) {
  return arguments.length === 1
    ? cubehelixConvert(h)
    : new Cubehelix(h, s2, l, opacity == null ? 1 : opacity);
}
function Cubehelix(h, s2, l, opacity) {
  this.h = +h;
  this.s = +s2;
...
function basis(t13, v0, v1, v2, v3) {
  var t22 = t13 * t13,
    t32 = t22 * t13;
  return (
    ((1 - 3 * t13 + 3 * t22 - t32) * v0 +
      (4 - 6 * t22 + 3 * t32) * v1 +
      (1 + 3 * t13 + 3 * t22 - 3 * t32) * v2 +
      t32 * v3) /
    6
  );
}
...
function hue(a4, b) {
  var d = b - a4;
  return d
    ? linear(a4, d > 180 || d < -180 ? d - 360 * Math.round(d / 360) : d)
    : constant_default3(isNaN(a4) ? b : a4);
}
function gamma(y4) {
  return (y4 = +y4) === 1
    ? nogamma
...
function parseCss(value) {
  ...
  return m3.isIdentity
    ? identity2
    : decompose_default(m3.a, m3.b, m3.c, m3.d, m3.e, m3.f);
}
...
function attr_default2(name, value) {
  var fullname = namespace_default(name),
    i =
      fullname === "transform" ? interpolateTransformSvg : interpolate_default;
...
function selectAll_default3(select) {
  ...
  for (
    ...
    for (var group2 = groups2[j], n = group2.length, node, i = 0; i < n; ++i) {
      if ((node = group2[i])) {
        for (
          var children2 = select.call(node, node.__data__, i, group2),
            child,
...
function style_default2(name, value, priority) {
  ...
  return value == null
    ...
    : typeof value === "function"
      ? this.styleTween(
          name,
          styleFunction2(name, i, tweenValue(this, "style." + name, value)),
        ).each(styleMaybeRemove(this._id, name))
      : this.styleTween(name, styleConstant2(name, i, value), priority).on(
          "end.style." + name,
          null,
        );
}
...
var elasticInOut = (function custom9(a4, p) {
  ...
  function elasticInOut2(t) {
    return (
      ((t = t * 2 - 1) < 0
        ? a4 * tpmt(-t) * Math.sin((s2 - t) / p)
        : 2 - a4 * tpmt(t) * Math.sin((s2 + t) / p)) / 2
    );
  }
...
function brush(dim) {
    ...
    overlay
      ...
      .each(function () {
        ...
        select_default2(this)
          .attr("x", extent3[0][0])
          .attr("y", extent3[0][1])
          .attr("width", extent3[1][0] - extent3[0][0])
          .attr("height", extent3[1][1] - extent3[0][1]);
      });
    group2
      .selectAll(".selection")
      .data([type("selection")])
  ...
  brush2.move = function (group2, selection2, event) {
    if (group2.tween) {
      group2
        .on("start.brush", function (event2) {
        ...
        .tween("brush", function () {
          var that = this,
            ...
            selection1 = dim.input(
              typeof selection2 === "function"
                ? selection2.apply(this, arguments)
                : selection2,
              state.extent,
            ),
  ...
  function redraw() {
    ...
    if (selection2) {
      ...
      group2
        ...
        .attr("y", function (d) {
          return d.type[0] === "s"
            ? selection2[1][1] - handleSize / 2
            : selection2[0][1] - handleSize / 2;
        })
        .attr("width", function (d) {
          return d.type === "n" || d.type === "s"
            ? selection2[1][0] - selection2[0][0] + handleSize
            : handleSize;
        })
        .attr("height", function (d) {
          return d.type === "e" || d.type === "w"
            ? selection2[1][1] - selection2[0][1] + handleSize
            : handleSize;
        });
    } else {
      group2
  ...
  function started(event) {
    ...
    if (event.touches) {
      ...
      var view = select_default2(event.view)
    ...
    function move(event2) {
      ...
      switch (mode2) {
        ...
        case MODE_DRAG: {
          if (signX)
            ((dx = max2(W - w0, min2(E2 - e0, dx))),
              (w1 = w0 + dx),
              (e1 = e0 + dx));
          if (signY)
            ((dy = max2(N - n0, min2(S - s0, dy))),
              (n1 = n0 + dy),
              (s1 = s0 + dy));
          break;
        }
        case MODE_HANDLE: {
          if (points[1]) {
            if (signX)
              ((w1 = max2(W, min2(E2, points[0][0]))),
                (e1 = max2(W, min2(E2, points[1][0]))),
                (signX = 1));
            if (signY)
              ((n1 = max2(N, min2(S, points[0][1]))),
                (s1 = max2(N, min2(S, points[1][1]))),
                (signY = 1));
          } else {
            if (signX < 0)
              ((dx = max2(W - w0, min2(E2 - w0, dx))),
                (w1 = w0 + dx),
                (e1 = e0));
            else if (signX > 0)
              ((dx = max2(W - e0, min2(E2 - e0, dx))),
                (w1 = w0),
                (e1 = e0 + dx));
            if (signY < 0)
              ((dy = max2(N - n0, min2(S - n0, dy))),
                (n1 = n0 + dy),
                (s1 = s0));
            else if (signY > 0)
              ((dy = max2(N - s0, min2(S - s0, dy))),
                (n1 = n0),
                (s1 = s0 + dy));
          }
          break;
        ...
        case MODE_CENTER: {
          if (signX)
            ((w1 = max2(W, min2(E2, w0 - dx * signX))),
              (e1 = max2(W, min2(E2, e0 + dx * signX))));
          if (signY)
            ((n1 = max2(N, min2(S, n0 - dy * signY))),
              (s1 = max2(N, min2(S, s0 + dy * signY))));
          break;
        }
      }
      if (e1 < w1) {
  ...
  brush2.extent = function (_) {
    return arguments.length
      ? ((extent2 =
          typeof _ === "function" ? _ : constant_default4(number22(_))),
        brush2)
      : extent2;
  };
  brush2.filter = function (_) {
    return arguments.length
      ? ((filter3 = typeof _ === "function" ? _ : constant_default4(!!_)),
        brush2)
      : filter3;
  };
  brush2.touchable = function (_) {
    return arguments.length
      ? ((touchable = typeof _ === "function" ? _ : constant_default4(!!_)),
        brush2)
      : touchable;
  };
  ...
  function chord2(matrix) {
    ...
    dx = k2 ? padAngle : tau2 / n;
    {
      ...
      for (const i of groupIndex) {
        const x06 = x4;
        if (directed) {
          const subgroupIndex = range2(~n + 1, n).filter((j) =>
            j < 0 ? matrix[~j * n + i] : matrix[i * n + j],
          );
          if (sortSubgroups)
            subgroupIndex.sort((a4, b) =>
              sortSubgroups(
                a4 < 0 ? -matrix[~a4 * n + i] : matrix[i * n + a4],
          ...
          const subgroupIndex = range2(0, n).filter(
            (j) => matrix[i * n + j] || matrix[j * n + i],
          );
          if (sortSubgroups)
            subgroupIndex.sort((a4, b) =>
              sortSubgroups(matrix[i * n + a4], matrix[i * n + b]),
            );
          for (const j of subgroupIndex) {
            let chord3;
            if (i < j) {
            ...
            if (
              chord3.source &&
              chord3.target &&
              chord3.source.value < chord3.target.value
            ) {
...
var Path = class {
  ...
  moveTo(x4, y4) {
    this
      ._append`M${(this._x0 = this._x1 = +x4)},${(this._y0 = this._y1 = +y4)}`;
  }
  closePath() {
    if (this._x1 !== null) {
  ...
  bezierCurveTo(x12, y12, x22, y22, x4, y4) {
    this
      ._append`C${+x12},${+y12},${+x22},${+y22},${(this._x1 = +x4)},${(this._y1 = +y4)}`;
  }
    ...
    if (this._x1 === null) {
      ...
      let x20 = x22 - x06,
        ...
        l =
          r *
          Math.tan(
            (pi3 - Math.acos((l21_2 + l01_2 - l20_2) / (2 * l21 * l01))) / 2,
          ),
        t01 = l / l01,
        t21 = l / l21;
      ...
      this
        ._append`A${r},${r},0,0,${+(y01 * x20 > x01 * y20)},${(this._x1 = x12 + t21 * x21)},${(this._y1 = y12 + t21 * y21)}`;
    }
  }
  arc(x4, y4, r, a0, a1, ccw) {
    ...
    if (this._x1 === null) {
      ...
      Math.abs(this._x1 - x06) > epsilon4 ||
      Math.abs(this._y1 - y06) > epsilon4
    ) {
    ...
    if (da2 > tauEpsilon) {
      this
        ._append`A${r},${r},0,1,${cw},${x4 - dx},${y4 - dy}A${r},${r},0,1,${cw},${(this._x1 = x06)},${(this._y1 = y06)}`;
    } else if (da2 > epsilon4) {
      this
        ._append`A${r},${r},0,${+(da2 >= pi3)},${cw},${(this._x1 = x4 + r * Math.cos(a1))},${(this._y1 = y4 + r * Math.sin(a1))}`;
    }
  }
  rect(x4, y4, w, h) {
    this
      ._append`M${(this._x0 = this._x1 = +x4)},${(this._y0 = this._y1 = +y4)}h${(w = +w)}v${+h}h${-w}Z`;
  }
  toString() {
    return this._;
  }
...
function ribbon(headRadius) {
  ...
  function ribbon2() {
    var buffer,
      s2 = source.apply(this, arguments),
  ...
  if (headRadius)
    ribbon2.headRadius = function (_) {
      return arguments.length
        ? ((headRadius = typeof _ === "function" ? _ : constant_default5(+_)),
          ribbon2)
        : headRadius;
    };
  ribbon2.radius = function (_) {
    return arguments.length
      ? ((sourceRadius = targetRadius =
          typeof _ === "function" ? _ : constant_default5(+_)),
        ribbon2)
      : sourceRadius;
  };
  ribbon2.sourceRadius = function (_) {
    return arguments.length
      ? ((sourceRadius = typeof _ === "function" ? _ : constant_default5(+_)),
        ribbon2)
      : sourceRadius;
  };
  ribbon2.targetRadius = function (_) {
    return arguments.length
      ? ((targetRadius = typeof _ === "function" ? _ : constant_default5(+_)),
        ribbon2)
      : targetRadius;
  };
  ribbon2.startAngle = function (_) {
    return arguments.length
      ? ((startAngle = typeof _ === "function" ? _ : constant_default5(+_)),
        ribbon2)
      : startAngle;
  };
  ribbon2.endAngle = function (_) {
    return arguments.length
      ? ((endAngle = typeof _ === "function" ? _ : constant_default5(+_)),
        ribbon2)
      : endAngle;
  };
  ribbon2.padAngle = function (_) {
    return arguments.length
      ? ((padAngle = typeof _ === "function" ? _ : constant_default5(+_)),
        ribbon2)
      : padAngle;
  };
...
function segmentContains(a4, b, c6) {
  var i;
  return (
    collinear(a4, b, c6) && within(a4[(i = +(a4[0] === b[0]))], c6[i], b[i])
  );
}
...
function contours_default() {
  ...
  function isorings(values, value, callback) {
    ...
    function stitch(line) {
      var start2 = [line[0][0] + x4, line[0][1] + y4],
        end = [line[1][0] + x4, line[1][1] + y4],
    ...
    return arguments.length
      ? ((threshold2 =
          typeof _ === "function"
            ? _
            : Array.isArray(_)
              ? constant_default6(slice3.call(_))
              : constant_default6(_)),
        contours)
      : threshold2;
  };
  contours.smooth = function (_) {
    return arguments.length
      ? ((smooth = _ ? smoothLinear : noop_default), contours)
      : smooth === smoothLinear;
  };
  return contours;
}
...
function density_default() {
  ...
  function grid(data) {
    var values = new Float32Array(n * m3),
      pow2k = Math.pow(2, -k2),
      i = -1;
    for (const d of data) {
  ...
  function density(data) {
    var values = grid(data),
      tz = threshold2(values),
      pow4k = Math.pow(2, 2 * k2);
    if (!Array.isArray(tz)) {
      tz = ticks(Number.MIN_VALUE, max(values) / pow4k, tz);
    }
    return contours_default()
      .size([n, m3])
      .thresholds(tz.map((d) => d * pow4k))(values)
      .map((c6, i) => ((c6.value = +tz[i]), transform2(c6)));
  }
  ...
  density.x = function (_) {
    return arguments.length
      ? ((x4 = typeof _ === "function" ? _ : constant_default6(+_)), density)
      : x4;
  };
  density.y = function (_) {
    return arguments.length
      ? ((y4 = typeof _ === "function" ? _ : constant_default6(+_)), density)
      : y4;
  };
  density.weight = function (_) {
    return arguments.length
      ? ((weight = typeof _ === "function" ? _ : constant_default6(+_)),
        density)
      : weight;
  };
...
var Delaunator = class _Delaunator {
  ...
  update() {
    ...
    for (let k2 = 0, xp, yp; k2 < this._ids.length; k2++) {
      ...
      if (
        k2 > 0 &&
        Math.abs(x4 - xp) <= EPSILON &&
        Math.abs(y4 - yp) <= EPSILON
      )
        continue;
      xp = x4;
      yp = y4;
  ...
  _hashKey(x4, y4) {
    return (
      Math.floor(pseudoAngle(x4 - this._cx, y4 - this._cy) * this._hashSize) %
      this._hashSize
    );
  }
  _legalize(a4) {
...
var Path2 = class {
  ...
  arc(x4, y4, r) {
    ...
    if (this._x1 === null) this._ += `M${x06},${y06}`;
      ...
      Math.abs(this._x1 - x06) > epsilon6 ||
      Math.abs(this._y1 - y06) > epsilon6
    )
      this._ += "L" + x06 + "," + y06;
    if (!r) return;
...
var Voronoi = class {
  ...
  _init() {
    ...
    for (
      let i = 0, j = 0, n = triangles.length, x4, y4;
      i < n;
      i += 3, j += 2
    ) {
  ...
  *neighbors(i) {
  ...
  _clip(i) {
    ...
    return this._simplify(
      V[v2] || V[v2 + 1]
        ? this._clipInfinite(i, points, V[v2], V[v2 + 1], V[v2 + 2], V[v2 + 3])
  ...
  _clipSegment(x06, y06, x12, y12, c0, c1) {
    ...
    while (true) {
      ...
      let x4,
        ...
        c6 = c0 || c1;
      if (c6 & 8)
        ((x4 = x06 + ((x12 - x06) * (this.ymax - y06)) / (y12 - y06)),
          (y4 = this.ymax));
      else if (c6 & 4)
        ((x4 = x06 + ((x12 - x06) * (this.ymin - y06)) / (y12 - y06)),
          (y4 = this.ymin));
      else if (c6 & 2)
        ((y4 = y06 + ((y12 - y06) * (this.xmax - x06)) / (x12 - x06)),
          (x4 = this.xmax));
      else
        ((y4 = y06 + ((y12 - y06) * (this.xmin - x06)) / (x12 - x06)),
          (x4 = this.xmin));
  ...
  _edgecode(x4, y4) {
    return (
      (x4 === this.xmin ? 1 : x4 === this.xmax ? 2 : 0) |
      (y4 === this.ymin ? 4 : y4 === this.ymax ? 8 : 0)
    );
  }
  _regioncode(x4, y4) {
    return (
...
function collinear2(d) {
  ...
  for (let i = 0; i < triangles.length; i += 3) {
    const a4 = 2 * triangles[i],
      ...
      c6 = 2 * triangles[i + 2],
      cross2 =
        (coords[c6] - coords[a4]) * (coords[b + 1] - coords[a4 + 1]) -
        (coords[b] - coords[a4]) * (coords[c6 + 1] - coords[a4 + 1]);
...
var fixtz =
  /* @__PURE__ */ new Date("2019-01-01T00:00").getHours() ||
  /* @__PURE__ */ new Date("2019-07-01T00:00").getHours();
...
function parser(type2) {
  return (input, init2) =>
    text_default3(input, init2).then((text) =>
      new DOMParser().parseFromString(text, type2),
    );
}
...
function center_default(x4, y4) {
  ...
  function force() {
    ...
    for (
      sx = (sx / n - x4) * strength, sy = (sy / n - y4) * strength, i = 0;
      i < n;
      ++i
    ) {
...
function add(tree, x4, y4, d) {
  ...
  do {
    ...
    (i = (bottom2 << 1) | right2) === (j = ((yp >= ym) << 1) | (xp >= xm))
  );
...
function addAll(data) {
  ...
  for (i = 0; i < n; ++i) {
    if (
      isNaN((x4 = +this._x.call(null, (d = data[i])))) ||
      isNaN((y4 = +this._y.call(null, d)))
    )
      continue;
    xz[i] = x4;
    yz[i] = y4;
...
function visitAfter_default(callback) {
  ...
  if (this._root)
    quads.push(
      new quad_default(this._root, this._x0, this._y0, this._x1, this._y1),
    );
  while ((q = quads.pop())) {
    var node = q.node;
    if (node.length) {
...
function quadtree(nodes, x4, y4) {
  var tree = new Quadtree(
    x4 == null ? defaultX2 : x4,
    y4 == null ? defaultY2 : y4,
    NaN,
    NaN,
    NaN,
    NaN,
...
function collide_default(radius) {
  ...
  force.radius = function (_) {
    return arguments.length
      ? ((radius = typeof _ === "function" ? _ : constant_default7(+_)),
        initialize(),
        force)
      : radius;
  };
...
function link_default(links) {
  ...
  function force(alpha) {
    for (var k2 = 0, n = links.length; k2 < iterations2; ++k2) {
      for (var i = 0, link3, source, target, x4, y4, l, b; i < n; ++i) {
        ...
        x4 =
          target.x + target.vx - source.x - source.vx || jiggle_default(random);
        y4 =
          target.y + target.vy - source.y - source.vy || jiggle_default(random);
  ...
  function initialize() {
    ...
    for (i = 0, bias = new Array(m3); i < m3; ++i) {
      ((link3 = links[i]),
        (bias[i] =
          count3[link3.source.index] /
          (count3[link3.source.index] + count3[link3.target.index])));
    }
  ...
  force.strength = function (_) {
    return arguments.length
      ? ((strength = typeof _ === "function" ? _ : constant_default7(+_)),
        initializeStrength(),
        force)
      : strength;
  };
  force.distance = function (_) {
    return arguments.length
      ? ((distance = typeof _ === "function" ? _ : constant_default7(+_)),
        initializeDistance(),
        force)
      : distance;
  };
...
function manyBody_default() {
  ...
  function force(_) {
    var i,
      n = nodes.length,
      tree = quadtree(nodes, x2, y2).visitAfter(accumulate);
...
function radial_default(radius, x4, y4) {
  var nodes,
    strength = constant_default7(0.1),
    strengths,
    radiuses;
...
function x_default2(x4) {
  ...
  function initialize() {
    ...
    xz = new Array(n);
    for (i = 0; i < n; ++i) {
      strengths[i] = isNaN((xz[i] = +x4(nodes[i], i, nodes)))
        ? 0
  ...
  force.x = function (_) {
    return arguments.length
      ? ((x4 = typeof _ === "function" ? _ : constant_default7(+_)),
        initialize(),
        force)
      : x4;
  };
...
function y_default2(y4) {
  ...
  function initialize() {
    ...
    yz = new Array(n);
    for (i = 0; i < n; ++i) {
      strengths[i] = isNaN((yz[i] = +y4(nodes[i], i, nodes)))
        ? 0
        : +strength(nodes[i], i, nodes);
    }
  }
  ...
  force.y = function (_) {
    return arguments.length
      ? ((y4 = typeof _ === "function" ? _ : constant_default7(+_)),
        initialize(),
        force)
      : y4;
  };
...
function formatDecimal_default(x4) {
  return Math.abs((x4 = Math.round(x4))) >= 1e21
    ? x4.toLocaleString("en").replace(/,/g, "")
    : x4.toString(10);
}
function formatDecimalParts(x4, p) {
  if (
    (i = (x4 = p ? x4.toExponential(p - 1) : x4.toExponential()).indexOf("e")) <
    0
  )
    return null;
  var i,
    coefficient = x4.slice(0, i);
  return [
    ...
    : i > n
      ...
      : i > 0
        ...
        : "0." +
          ...
          formatDecimalParts(x4, Math.max(0, p + i - 1))[0];
}
  ...
  var group2 =
    ...
    numerals =
      locale3.numerals === void 0
        ? identity_default2
        : formatNumerals_default(map3.call(locale3.numerals, String)),
  ...
  function newFormat(specifier) {
    ...
    var prefix =
        symbol === "$"
          ...
          : symbol === "#" && /[boxX]/.test(type2)
            ...
            : "",
      suffix =
        symbol === "$" ? currencySuffix : /[%p]/.test(type2) ? percent : "";
    ...
    function format2(value) {
        ...
        if (maybeSuffix) {
          ...
          while (++i < n) {
            if (((c6 = value.charCodeAt(i)), 48 > c6 || c6 > 57)) {
              valueSuffix =
                (c6 === 46 ? decimal + value.slice(i + 1) : value.slice(i)) +
                valueSuffix;
      ...
      var length3 = valuePrefix.length + value.length + valueSuffix.length,
        padding =
          length3 < width ? new Array(width - length3 + 1).join(fill) : "";
      if (comma && zero3)
        ((value = group2(
          padding + value,
...
function areaPointFirst(lambda, phi2) {
  ...
  ((lambda0 = lambda),
    (cosPhi0 = cos2((phi2 = phi2 / 2 + quarterPi))),
    (sinPhi0 = sin2(phi2)));
}
...
function rangeContains(range4, x4) {
  return range4[0] <= range4[1]
    ? range4[0] <= x4 && x4 <= range4[1]
    : x4 < range4[0] || range4[1] < x4;
}
function bounds_default(feature) {
  ...
  if ((n = ranges.length)) {
    ...
    for (
      deltaMax = -Infinity, n = merged.length - 1, i = 0, a4 = merged[n];
      i <= n;
      a4 = b, ++i
    ) {
      b = merged[i];
...
function rotationPhiGamma(deltaPhi, deltaGamma) {
  ...
  function rotation(lambda, phi2) {
    ...
    return [
      atan2(
        y4 * cosDeltaGamma - k2 * sinDeltaGamma,
        x4 * cosDeltaPhi - z * sinDeltaPhi,
      ),
  ...
  rotation.invert = function (lambda, phi2) {
    ...
    return [
      atan2(
        y4 * cosDeltaGamma + z * sinDeltaGamma,
        x4 * cosDeltaPhi + k2 * sinDeltaPhi,
      ),
...
function rotation_default(rotate) {
  rotate = rotateRadians(
    rotate[0] * radians2,
    rotate[1] * radians2,
    rotate.length > 2 ? rotate[2] * radians2 : 0,
  );
  function forward(coordinates2) {
    coordinates2 = rotate(
      coordinates2[0] * radians2,
      coordinates2[1] * radians2,
    );
    return (
      (coordinates2[0] *= degrees3),
      (coordinates2[1] *= degrees3),
      coordinates2
    );
  }
...
function circle_default() {
  var center2 = constant_default8([0, 0]),
    radius = constant_default8(90),
    precision = constant_default8(2),
    ring,
    rotate,
    stream = { point: point6 };
  ...
  function circle() {
    var c6 = center2.apply(this, arguments),
      r = radius.apply(this, arguments) * radians2,
  ...
  circle.center = function (_) {
    return arguments.length
      ? ((center2 =
          typeof _ === "function" ? _ : constant_default8([+_[0], +_[1]])),
        circle)
      : center2;
  };
  circle.radius = function (_) {
    return arguments.length
      ? ((radius = typeof _ === "function" ? _ : constant_default8(+_)), circle)
      : radius;
  };
  circle.precision = function (_) {
    return arguments.length
      ? ((precision = typeof _ === "function" ? _ : constant_default8(+_)),
        circle)
      : precision;
  };
  return circle;
...
function longitude(point6) {
  return abs3(point6[0]) <= pi4
    ? point6[0]
    : sign(point6[0]) * (((abs3(point6[0]) + pi4) % tau5) - pi4);
}
function polygonContains_default(polygon, point6) {
  ...
  for (var i = 0, n = polygon.length; i < n; ++i) {
    ...
    for (
      ...
      sum4.add(
        atan2(
          k2 * sign3 * sin2(absDelta),
          cosPhi03 * cosPhi1 + k2 * cos2(absDelta),
        ),
      );
      ...
      if (antimeridian ^ (lambda04 >= lambda) ^ (lambda12 >= lambda)) {
        ...
        var phiArc =
          (antimeridian ^ (delta >= 0) ? -1 : 1) * asin(intersection2[2]);
  ...
  return (
    (angle2 < -epsilon7 || (angle2 < epsilon7 && sum4 < -epsilon22)) ^
    (winding & 1)
  );
}
...
function compareIntersection(a4, b) {
  return (
    ((a4 = a4.x)[0] < 0 ? a4[1] - halfPi3 - epsilon7 : halfPi3 - a4[1]) -
    ((b = b.x)[0] < 0 ? b[1] - halfPi3 - epsilon7 : halfPi3 - b[1])
  );
}
  ...
  return {
    ...
    point: function (lambda12, phi12) {
      ...
      if (abs3(delta - pi4) < epsilon7) {
        stream.point(
          lambda04,
          (phi02 = (phi02 + phi12) / 2 > 0 ? halfPi3 : -halfPi3),
        );
...
function clipAntimeridianIntersect(lambda04, phi02, lambda12, phi12) {
  ...
  return abs3(sinLambda0Lambda1) > epsilon7
    ? atan(
...
function circle_default2(radius) {
    ...
    return {
      ...
      point: function (lambda, phi2) {
        var point1 = [lambda, phi2],
          point22,
          v2 = visible(lambda, phi2),
          c6 = smallRadius
            ? v2
              ? 0
              : code(lambda, phi2)
            : v2
              ? code(lambda + (lambda < 0 ? pi4 : -pi4), phi2)
              : 0;
        ...
        if (v2 !== v0) {
          ...
          if (
            !point22 ||
            pointEqual_default(point0, point22) ||
            pointEqual_default(point1, point22)
          )
            point1[2] = 1;
        }
        if (v2 !== v0) {
  ...
  function intersect2(a4, b, two) {
    ...
    if (
      meridian
        ? polar
          ? (phi02 + phi12 > 0) ^
            (q[1] < (abs3(q[0] - lambda04) < epsilon7 ? phi02 : phi12))
          : phi02 <= q[1] && q[1] <= phi12
  ...
  function code(lambda, phi2) {
    var r = smallRadius ? radius : pi4 - radius,
      code2 = 0;
    if (lambda < -r) code2 |= 1;
  ...
  return clip_default(
    ...
    clipLine,
    interpolate,
    smallRadius ? [0, -radius] : [-pi4, radius - pi4],
  );
}
...
function clipRectangle(x06, y06, x12, y12) {
  ...
  function interpolate(from, to, direction, stream) {
    ...
    if (
      from == null ||
      (a4 = corner(from, direction)) !== (a1 = corner(to, direction)) ||
      (comparePoint(from, to) < 0) ^ (direction > 0)
    ) {
      do stream.point(a4 === 0 || a4 === 3 ? x06 : x12, a4 > 1 ? y12 : y06);
  ...
  function corner(p, direction) {
    return abs3(p[0] - x06) < epsilon7
      ? direction > 0
        ? 0
        : 3
      : abs3(p[0] - x12) < epsilon7
        ? direction > 0
          ? 2
          : 1
        : abs3(p[1] - y06) < epsilon7
          ? direction > 0
            ? 1
            : 0
          : direction > 0
      ...
      if (first) {
        ...
        if (v2 && v_) activeStream.point(x4, y4);
          ...
          var a4 = [
            ...
            b = [
              (x4 = Math.max(clipMin, Math.min(clipMax, x4))),
              (y4 = Math.max(clipMin, Math.min(clipMax, y4))),
            ];
...
var containsObjectType = {
  ...
  FeatureCollection: function (object2, point6) {
    var features = object2.features,
      ...
      n = features.length;
    while (++i < n)
      if (containsGeometry(features[i].geometry, point6)) return true;
    return false;
  },
};
  ...
  for (var i = 0, n = coordinates2.length; i < n; i++) {
    ...
    if (i > 0) {
      ...
      if (
        ...
        ao <= ab4 &&
        bo <= ab4 &&
        (ao + bo - ab4) * (1 - Math.pow((ao - bo) / ab4, 2)) < epsilon22 * ab4
      )
        return true;
    }
    ao = bo;
...
function containsPolygon(coordinates2, point6) {
  return !!polygonContains_default(
...
function graticule() {
  ...
  function lines() {
    return range(ceil(X03 / DX) * DX, X13, DX)
      .map(X3)
      .concat(range(ceil(Y03 / DY) * DY, Y13, DY).map(Y3))
      .concat(
        range(ceil(x06 / dx) * dx, x12, dx)
          .filter(function (x5) {
...
function path_default(projection2, context) {
  ...
  path2.projection = function (_) {
    ...
    projectionStream =
      _ == null
        ? ((projection2 = null), identity_default3)
  ...
  return fit(
    ...
    function (b) {
      var w = extent2[1][0] - extent2[0][0],
        ...
        x4 = +extent2[0][0] + (w - k2 * (b[1][0] + b[0][0])) / 2,
        y4 = +extent2[0][1] + (h - k2 * (b[1][1] + b[0][1])) / 2;
...
function resample(project, delta2) {
  function resampleLineTo(
    ...
    if (d2 > 4 * delta2 && depth--) {
      var a4 = a0 + a1,
        ...
        phi2 = asin((c6 /= m3)),
        lambda22 =
          abs3(abs3(c6) - 1) < epsilon7 || abs3(lambda04 - lambda12) < epsilon7
            ? (lambda04 + lambda12) / 2
            : atan2(b, a4),
  ...
  return function (stream) {
    ...
    function ringPoint(lambda, phi2) {
      (linePoint2((lambda004 = lambda), phi2),
        (x004 = x06),
        (y004 = y06),
        (a00 = a0),
        (b00 = b02),
...
function projectionMutator(projectAt) {
  ...
  projection2.postclip = function (_) {
    return arguments.length
      ? ((postclip = _), (x06 = y06 = x12 = y12 = null), reset())
      : postclip;
  };
  projection2.clipAngle = function (_) {
    return arguments.length
      ? ((preclip = +_
          ? circle_default2((theta = _ * radians2))
          : ((theta = null), antimeridian_default)),
        reset())
      : theta * degrees3;
  };
  projection2.clipExtent = function (_) {
    return arguments.length
      ? ((postclip =
          _ == null
            ? ((x06 = y06 = x12 = y12 = null), identity_default3)
            : clipRectangle(
                (x06 = +_[0][0]),
                (y06 = +_[0][1]),
                (x12 = +_[1][0]),
  ...
  projection2.translate = function (_) {
    return arguments.length
      ? ((x4 = +_[0]), (y4 = +_[1]), recenter())
      : [x4, y4];
  };
  projection2.center = function (_) {
    return arguments.length
      ? ((lambda = (_[0] % 360) * radians2),
        (phi2 = (_[1] % 360) * radians2),
        recenter())
      : [lambda * degrees3, phi2 * degrees3];
  };
  projection2.rotate = function (_) {
    return arguments.length
      ? ((deltaLambda = (_[0] % 360) * radians2),
        (deltaPhi = (_[1] % 360) * radians2),
        (deltaGamma = _.length > 2 ? (_[2] % 360) * radians2 : 0),
        recenter())
      : [deltaLambda * degrees3, deltaPhi * degrees3, deltaGamma * degrees3];
  };
  projection2.angle = function (_) {
    return arguments.length
      ? ((alpha = (_ % 360) * radians2), recenter())
      : alpha * degrees3;
  };
  ...
  projection2.precision = function (_) {
    return arguments.length
      ? ((projectResample = resample_default(
          projectTransform,
          (delta2 = _ * _),
        )),
        reset())
  ...
  function recenter() {
    var center2 = scaleTranslateRotate(k2, 0, 0, sx, sy, alpha).apply(
        null,
        project(lambda, phi2),
      ),
      transform2 = scaleTranslateRotate(
        k2,
        x4 - center2[0],
        y4 - center2[1],
        sx,
...
function conicProjection(projectAt) {
  ...
  p.parallels = function (_) {
    return arguments.length
      ? m3((phi02 = _[0] * radians2), (phi12 = _[1] * radians2))
...
function albersUsa_default() {
  var cache,
    ...
    lower48Point,
    alaska = conicEqualArea_default()
      .rotate([154, 0])
      .center([-2, 58.5])
      .parallels([55, 65]),
    alaskaPoint,
    hawaii = conicEqualArea_default()
      .rotate([157, 0])
      .center([-3, 19.9])
      .parallels([8, 18]),
    hawaiiPoint,
  ...
  function albersUsa(coordinates2) {
    ...
    return (
      (point6 = null),
      (lower48Point.point(x4, y4), point6) ||
        (alaskaPoint.point(x4, y4), point6) ||
        (hawaiiPoint.point(x4, y4), point6)
    );
  }
  albersUsa.invert = function (coordinates2) {
    ...
    return (
      y4 >= 0.12 && y4 < 0.234 && x4 >= -0.425 && x4 < -0.214
        ? alaska
        : y4 >= 0.166 && y4 < 0.234 && x4 >= -0.214 && x4 < -0.115
          ? hawaii
          : lower48
    ).invert(coordinates2);
  };
  ...
  albersUsa.translate = function (_) {
    ...
    lower48Point = lower48
      ...
      .stream(pointStream);
    alaskaPoint = alaska
      .translate([x4 - 0.307 * k2, y4 + 0.201 * k2])
      .clipExtent([
      ...
      .stream(pointStream);
    hawaiiPoint = hawaii
      .translate([x4 - 0.205 * k2, y4 + 0.212 * k2])
      .clipExtent([
...
function conicConformalRaw(y06, y12) {
  var cy0 = cos2(y06),
    n =
      y06 === y12
        ? sin2(y06)
        : log(cy0 / cos2(y12)) / log(tany(y12) / tany(y06)),
...
function naturalEarth1Raw(lambda, phi2) {
  ...
  return [
    lambda *
      (0.8707 -
        0.131979 * phi22 +
        phi4 * (-0.013791 + phi4 * (3971e-6 * phi22 - 1529e-6 * phi4))),
    phi2 *
      (1.007226 +
        phi22 *
          (0.015085 + phi4 * (-0.044475 + 0.028874 * phi22 - 5916e-6 * phi4))),
  ];
}
    ...
    phi2 -= delta =
      (phi2 *
        (1.007226 +
          phi22 *
            (0.015085 +
              phi4 * (-0.044475 + 0.028874 * phi22 - 5916e-6 * phi4))) -
        y4) /
      (1.007226 +
        phi22 *
          (0.015085 * 3 +
            phi4 *
              (-0.044475 * 7 + 0.028874 * 9 * phi22 - 5916e-6 * 11 * phi4)));
      ...
      (0.8707 +
        (phi22 = phi2 * phi2) *
          (-0.131979 +
            phi22 *
              (-0.013791 +
                phi22 * phi22 * phi22 * (3971e-6 - 1529e-6 * phi22)))),
    phi2,
  ];
};
...
function cluster_default() {
  ...
  cluster.size = function (x4) {
    return arguments.length
      ? ((nodeSize = false), (dx = +x4[0]), (dy = +x4[1]), cluster)
      : nodeSize
        ? null
        : [dx, dy];
  };
  cluster.nodeSize = function (x4) {
    return arguments.length
      ? ((nodeSize = true), (dx = +x4[0]), (dy = +x4[1]), cluster)
      : nodeSize
        ? [dx, dy]
        : null;
  };
...
function extendBasis(B3, p) {
  ...
  for (i = 0; i < B3.length - 1; ++i) {
    for (j = i + 1; j < B3.length; ++j) {
      if (
        enclosesNot(encloseBasis2(B3[i], B3[j]), p) &&
        enclosesNot(encloseBasis2(B3[i], p), B3[j]) &&
        enclosesNot(encloseBasis2(B3[j], p), B3[i]) &&
        enclosesWeakAll(encloseBasis3(B3[i], B3[j], p), B3)
      ) {
        return [B3[i], B3[j], p];
      }
    }
...
function encloseBasis3(a4, b, c6) {
  var x12 = a4.x,
    ...
    r = -(Math.abs(A5) > 1e-6
      ? (B3 + Math.sqrt(B3 * B3 - 4 * A5 * C3)) / (2 * A5)
      : C3 / B3);
  return {
    x: x12 + xa + xb * r,
    y: y12 + ya + yb * r,
...
function pack_default() {
  ...
  function pack(root3) {
    ...
    if (radius) {
      ...
      root3
        ...
        .eachAfter(
          packChildrenRandom(padding, root3.r / Math.min(dx, dy), random),
        )
  ...
  pack.padding = function (x4) {
    return arguments.length
      ? ((padding = typeof x4 === "function" ? x4 : constant_default9(+x4)),
        pack)
      : padding;
  };
  return pack;
...
function tree_default() {
  ...
  tree.size = function (x4) {
    return arguments.length
      ? ((nodeSize = false), (dx = +x4[0]), (dy = +x4[1]), tree)
      : nodeSize
        ? null
        : [dx, dy];
  };
  tree.nodeSize = function (x4) {
    return arguments.length
      ? ((nodeSize = true), (dx = +x4[0]), (dy = +x4[1]), tree)
      : nodeSize
        ? [dx, dy]
        : null;
  };
  ...
  while (i0 < n) {
    ...
    if (row.dice)
      dice_default(
        ...
        y06,
        x12,
        value ? (y06 += (dy * sumValue) / value) : y12,
      );
    else
      slice_default(
        row,
        x06,
        y06,
        value ? (x06 += (dx * sumValue) / value) : x12,
        y12,
      );
...
function treemap_default() {
  ...
  treemap.padding = function (x4) {
    return arguments.length
      ? treemap.paddingInner(x4).paddingOuter(x4)
      : treemap.paddingInner();
  };
  treemap.paddingInner = function (x4) {
    return arguments.length
      ? ((paddingInner =
          typeof x4 === "function" ? x4 : constant_default9(+x4)),
        treemap)
      : paddingInner;
  };
  ...
  treemap.paddingTop = function (x4) {
    return arguments.length
      ? ((paddingTop = typeof x4 === "function" ? x4 : constant_default9(+x4)),
        treemap)
      : paddingTop;
  };
  ...
  treemap.paddingLeft = function (x4) {
    return arguments.length
      ? ((paddingLeft = typeof x4 === "function" ? x4 : constant_default9(+x4)),
        treemap)
      : paddingLeft;
  };
  return treemap;
      ...
      while (++j < m3) {
        ...
        if (row.dice)
          dice_default(
            ...
            y06,
            x12,
            value ? (y06 += ((y12 - y06) * row.value) / value) : y12,
          );
        else
          slice_default(
            row,
            x06,
            y06,
            value ? (x06 += ((x12 - x06) * row.value) / value) : x12,
            y12,
          );
        value -= row.value;
      }
...
function computeUpperHullIndexes(points) {
  ...
  for (i = 2; i < n; ++i) {
    while (
      size > 1 &&
      cross_default(
        points[indexes2[size - 2]],
        points[indexes2[size - 1]],
        points[i],
      ) <= 0
    )
      --size;
  ...
  function randomGamma(k2, theta) {
    ...
    return function () {
      do {
        ...
        u4 >= 1 - 0.0331 * x4 * x4 * x4 * x4 &&
        Math.log(u4) >= 0.5 * x4 * x4 + d * (1 - v2 + Math.log(v2))
      );
...
function band() {
  var scale2 = ordinal().unknown(void 0),
    domain = scale2.domain,
    ordinalRange = scale2.range,
    r0 = 0,
    r1 = 1,
    step,
    bandwidth,
...
function polymap(domain, range4, interpolate) {
  var j = Math.min(domain.length, range4.length) - 1,
    d = new Array(j),
    r = new Array(j),
    i = -1;
...
function transformer2() {
  ...
  function scale2(x4) {
    return x4 == null || isNaN((x4 = +x4))
      ? unknown
      : (
          output ||
          (output = piecewise2(domain.map(transform2), range4, interpolate))
        )(transform2(clamp(x4)));
  }
  scale2.invert = function (y4) {
    return clamp(
      untransform(
        (
          input ||
          (input = piecewise2(range4, domain.map(transform2), number_default))
        )(y4),
      ),
    );
  };
  scale2.domain = function (_) {
    return arguments.length
      ? ((domain = Array.from(_, number3)), rescale())
      : domain.slice();
  };
  scale2.range = function (_) {
    return arguments.length
      ? ((range4 = Array.from(_)), rescale())
      : range4.slice();
  };
  scale2.rangeRound = function (_) {
...
function identity4(domain) {
  ...
  scale2.domain = scale2.range = function (_) {
    return arguments.length
      ? ((domain = Array.from(_, number3)), scale2)
      : domain.slice();
  };
  scale2.unknown = function (_) {
    return arguments.length ? ((unknown = _), scale2) : unknown;
...
function logp(base) {
  return base === Math.E
    ...
    : (base === 10 && Math.log10) ||
        (base === 2 && Math.log2) ||
        ((base = Math.log(base)), (x4) => Math.log(x4) / base);
}
function reflect(f) {
...
function symlogish(transform2) {
  var c6 = 1,
    scale2 = transform2(transformSymlog(c6), transformSymexp(c6));
  scale2.constant = function (_) {
    return arguments.length
      ? transform2(transformSymlog((c6 = +_)), transformSymexp(c6))
      : c6;
  };
  return linearish(scale2);
}
...
function powish(transform2) {
  var scale2 = transform2(identity3, identity3),
    exponent2 = 1;
  function rescale() {
    return exponent2 === 1
      ? transform2(identity3, identity3)
      : exponent2 === 0.5
...
function radial() {
  ...
  scale2.range = function (_) {
    return arguments.length
      ? (squared.range((range4 = Array.from(_, number3)).map(square)), scale2)
      : range4.slice();
  };
  scale2.rangeRound = function (_) {
  ...
  scale2.copy = function () {
    return radial(squared.domain(), range4)
      .round(round)
      .clamp(squared.clamp())
      .unknown(unknown);
  };
...
function quantile2() {
  ...
  function scale2(x4) {
    return x4 == null || isNaN((x4 = +x4))
      ? unknown
      : range4[bisect_default(thresholds, x4)];
  }
...
function quantize() {
  var x06 = 0,
    ...
    unknown;
  function scale2(x4) {
    return x4 != null && x4 <= x4
      ? range4[bisect_default(domain, x4, 0, n)]
      : unknown;
  }
  function rescale() {
    var i = -1;
  ...
  scale2.domain = function (_) {
    return arguments.length
      ? (([x06, x12] = _), (x06 = +x06), (x12 = +x12), rescale())
      : [x06, x12];
  };
  scale2.range = function (_) {
    return arguments.length
      ? ((n = (range4 = Array.from(_)).length - 1), rescale())
      : range4.slice();
  };
  scale2.invertExtent = function (y4) {
    var i = range4.indexOf(y4);
...
function threshold() {
  ...
  scale2.domain = function (_) {
    return arguments.length
      ? ((domain = Array.from(_)),
        (n = Math.min(domain.length, range4.length - 1)),
        scale2)
      : domain.slice();
  };
  scale2.range = function (_) {
...
function timeInterval(floori, offseti, count3, field) {
  ...
  interval2.range = (start2, stop, step) => {
    ...
    let previous;
    do
      (range4.push((previous = /* @__PURE__ */ new Date(+start2))),
        offseti(start2, step),
        floori(start2));
...
function ticker(year, month, week, day, hour, minute) {
  ...
  function ticks2(start2, stop, count3) {
    ...
    const interval2 =
      count3 && typeof count3.range === "function"
        ? count3
        : tickInterval(start2, stop, count3);
  ...
  function tickInterval(start2, stop, count3) {
    ...
    if (i === tickIntervals.length)
      return year.every(
        tickStep(start2 / durationYear, stop / durationYear, count3),
      );
    if (i === 0)
...
function pad2(value, fill, width) {
  ...
  return (
    sign3 +
    (length3 < width
      ? new Array(width - length3 + 1).join(fill) + string
      : string)
  );
}
function requote(s2) {
...
var parseIso = +(/* @__PURE__ */ new Date("2000-01-01T00:00:00.000Z"))
  ? parseIsoNative
...
function transformer3() {
  ...
  function scale2(x4) {
    return x4 == null || isNaN((x4 = +x4))
      ...
      : interpolator(
          k10 === 0
            ? 0.5
            : ((x4 = (transform2(x4) - t03) * k10),
              clamp ? Math.max(0, Math.min(1, x4)) : x4),
        );
  }
  scale2.domain = function (_) {
    return arguments.length
  ...
  function range4(interpolate) {
    return function (_) {
      var r0, r1;
      return arguments.length
        ? (([r0, r1] = _), (interpolator = interpolate(r0, r1)), scale2)
...
function sequentialQuantile() {
  ...
  function scale2(x4) {
    if (x4 != null && !isNaN((x4 = +x4)))
      return interpolator(
        (bisect_default(domain, x4, 1) - 1) / (domain.length - 1),
      );
  }
  scale2.domain = function (_) {
    if (!arguments.length) return domain.slice();
...
function transformer4() {
  ...
  function scale2(x4) {
    return isNaN((x4 = +x4))
      ...
      : ((x4 =
          0.5 +
          ((x4 = +transform2(x4)) - t13) * (s2 * x4 < s2 * t13 ? k10 : k21)),
        interpolator(clamp ? Math.max(0, Math.min(1, x4)) : x4));
  }
  scale2.domain = function (_) {
    return arguments.length
      ? (([x06, x12, x22] = _),
        (t03 = transform2((x06 = +x06))),
        (t13 = transform2((x12 = +x12))),
        (t22 = transform2((x22 = +x22))),
        (k10 = t03 === t13 ? 0 : 0.5 / (t13 - t03)),
        (k21 = t13 === t22 ? 0 : 0.5 / (t22 - t13)),
        (s2 = t13 < t03 ? -1 : 1),
        scale2)
      : [x06, x12, x22];
  };
...
var cubehelix_default2 = cubehelixLong(
  cubehelix(300, 0.5, 0),
  cubehelix(-240, 0.5, 1),
);
...
function arc_default() {
            ...
            var ax = x01 - oc[0],
              ...
              kc =
                ...
                sin3(
                  acos2(
                    (ax * bx + ay * by) /
                      (sqrt3(ax * ax + ay * ay) * sqrt3(bx * bx + by * by)),
                  ) / 2,
                ),
      ...
      if (!(da1 > epsilon8)) context.moveTo(x01, y01);
        ...
        if (rc1 < rc)
          context.arc(
            ...
            t03.cy,
            rc1,
            atan22(t03.y01, t03.x01),
            atan22(t13.y01, t13.x01),
            !cw,
          );
        else {
          context.arc(
  ...
  arc.innerRadius = function (_) {
    return arguments.length
      ? ((innerRadius = typeof _ === "function" ? _ : constant_default10(+_)),
        arc)
      : innerRadius;
  };
  arc.outerRadius = function (_) {
    return arguments.length
      ? ((outerRadius = typeof _ === "function" ? _ : constant_default10(+_)),
        arc)
      : outerRadius;
  };
  arc.cornerRadius = function (_) {
    return arguments.length
      ? ((cornerRadius = typeof _ === "function" ? _ : constant_default10(+_)),
        arc)
      : cornerRadius;
  };
    ...
    return arguments.length
      ? ((padRadius =
          _ == null
            ...
            : typeof _ === "function"
              ? _
              : constant_default10(+_)),
        arc)
      : padRadius;
  };
  arc.startAngle = function (_) {
    return arguments.length
      ? ((startAngle = typeof _ === "function" ? _ : constant_default10(+_)),
        arc)
      : startAngle;
  };
  arc.endAngle = function (_) {
    return arguments.length
      ? ((endAngle = typeof _ === "function" ? _ : constant_default10(+_)), arc)
      : endAngle;
  };
  arc.padAngle = function (_) {
    return arguments.length
      ? ((padAngle = typeof _ === "function" ? _ : constant_default10(+_)), arc)
      : padAngle;
  };
...
function line_default2(x4, y4) {
  var defined = constant_default10(true),
    context = null,
    curve = linear_default,
    output = null,
    path2 = withPath(line);
  x4 =
    typeof x4 === "function" ? x4 : x4 === void 0 ? x3 : constant_default10(x4);
  y4 =
    typeof y4 === "function" ? y4 : y4 === void 0 ? y3 : constant_default10(y4);
  function line(data) {
    var i,
      n = (data = array_default3(data)).length,
      d,
      defined0 = false,
      buffer;
  ...
  line.x = function (_) {
    return arguments.length
      ? ((x4 = typeof _ === "function" ? _ : constant_default10(+_)), line)
      : x4;
  };
  line.y = function (_) {
    return arguments.length
      ? ((y4 = typeof _ === "function" ? _ : constant_default10(+_)), line)
      : y4;
  };
  line.defined = function (_) {
    return arguments.length
      ? ((defined = typeof _ === "function" ? _ : constant_default10(!!_)),
        line)
      : defined;
  };
...
function area_default5(x06, y06, y12) {
  var x12 = null,
    defined = constant_default10(true),
    context = null,
    curve = linear_default,
    output = null,
    path2 = withPath(area);
  x06 =
    typeof x06 === "function"
      ...
      : x06 === void 0
        ? x3
        : constant_default10(+x06);
  y06 =
    typeof y06 === "function"
      ? y06
      : y06 === void 0
        ? constant_default10(0)
        : constant_default10(+y06);
  y12 =
    typeof y12 === "function"
      ? y12
      : y12 === void 0
        ? y3
        : constant_default10(+y12);
  function area(data) {
    var i,
      j,
      k2,
  ...
  area.x = function (_) {
    return arguments.length
      ? ((x06 = typeof _ === "function" ? _ : constant_default10(+_)),
        (x12 = null),
        area)
      : x06;
  };
  area.x0 = function (_) {
    return arguments.length
      ? ((x06 = typeof _ === "function" ? _ : constant_default10(+_)), area)
      : x06;
  };
  area.x1 = function (_) {
    return arguments.length
  ...
  area.y = function (_) {
    return arguments.length
      ? ((y06 = typeof _ === "function" ? _ : constant_default10(+_)),
        (y12 = null),
        area)
      : y06;
  };
  area.y0 = function (_) {
    return arguments.length
      ? ((y06 = typeof _ === "function" ? _ : constant_default10(+_)), area)
      : y06;
  };
  area.y1 = function (_) {
    return arguments.length
...
function pie_default() {
  ...
  function pie(data) {
    var i,
      ...
      da2 = Math.min(
        tau6,
        Math.max(-tau6, endAngle.apply(this, arguments) - a0),
      ),
      a1,
      p = Math.min(Math.abs(da2) / n, padAngle.apply(this, arguments)),
      pa = p * (da2 < 0 ? -1 : 1),
      v2;
    for (i = 0; i < n; ++i) {
  ...
  pie.value = function (_) {
    return arguments.length
      ? ((value = typeof _ === "function" ? _ : constant_default10(+_)), pie)
      : value;
  };
  pie.sortValues = function (_) {
    return arguments.length
      ? ((sortValues = _), (sort2 = null), pie)
      : sortValues;
  };
  pie.sort = function (_) {
  ...
  pie.endAngle = function (_) {
    return arguments.length
      ? ((endAngle = typeof _ === "function" ? _ : constant_default10(+_)), pie)
      : endAngle;
  };
  pie.padAngle = function (_) {
    return arguments.length
      ? ((padAngle = typeof _ === "function" ? _ : constant_default10(+_)), pie)
      : padAngle;
  };
  return pie;
}
...
function link2(curve) {
  ...
  function link3() {
    ...
    output.lineStart();
    ((argv[0] = s2),
      output.point(+x4.apply(this, argv), +y4.apply(this, argv)));
  ...
  link3.x = function (_) {
    return arguments.length
      ? ((x4 = typeof _ === "function" ? _ : constant_default10(+_)), link3)
      : x4;
  };
  link3.y = function (_) {
    return arguments.length
      ? ((y4 = typeof _ === "function" ? _ : constant_default10(+_)), link3)
      : y4;
  };
...
function Symbol2(type2, size) {
  ...
  type2 =
    typeof type2 === "function"
      ? type2
      : constant_default10(type2 || circle_default3);
  size =
    typeof size === "function"
      ? size
      : constant_default10(size === void 0 ? 64 : +size);
  function symbol() {
    let buffer;
    if (!context) context = buffer = path2();
  ...
  symbol.type = function (_) {
    return arguments.length
      ? ((type2 = typeof _ === "function" ? _ : constant_default10(_)), symbol)
      : type2;
  };
  symbol.size = function (_) {
    return arguments.length
      ? ((size = typeof _ === "function" ? _ : constant_default10(+_)), symbol)
      : size;
  };
  ...
  point: function (x4, y4) {
    ...
    switch (this._point) {
      ...
      case 2:
        ...
        this._context.moveTo(
          (this._x0 + 4 * this._x1 + x4) / 6,
          (this._y0 + 4 * this._y1 + y4) / 6,
        );
        break;
      default:
        point2(this, x4, y4);
  ...
  point: function (x4, y4) {
    ...
    switch (this._point) {
      ...
      case 2:
        ...
        this._line
          ? this._context.lineTo(x06, y06)
          : this._context.moveTo(x06, y06);
        break;
      case 3:
        this._point = 4;
      // falls through
...
Natural.prototype = {
  ...
  lineEnd: function () {
    ...
    if (n) {
      this._line
        ? this._context.lineTo(x4[0], y4[0])
        : this._context.moveTo(x4[0], y4[0]);
      if (n === 2) {
...
function stack_default() {
  ...
  stack.keys = function (_) {
    return arguments.length
      ? ((keys =
          typeof _ === "function" ? _ : constant_default10(Array.from(_))),
        stack)
      : keys;
  };
  stack.value = function (_) {
    return arguments.length
      ? ((value = typeof _ === "function" ? _ : constant_default10(+_)), stack)
      : value;
  };
    ...
    return arguments.length
      ? ((order =
          _ == null
            ...
            : typeof _ === "function"
              ? _
              : constant_default10(Array.from(_))),
        stack)
      : order;
  };
...
function diverging_default(series, order) {
  if (!((n = series.length) > 0)) return;
  for (
    var i, j = 0, d, dy, yp, yn, n, m3 = series[order[0]].length;
    j < m3;
    ++j
  ) {
...
function ZoomEvent(
  type2,
  { sourceEvent, target, transform: transform2, dispatch: dispatch2 },
) {
  Object.defineProperties(this, {
    type: { value: type2, enumerable: true, configurable: true },
    sourceEvent: { value: sourceEvent, enumerable: true, configurable: true },
...
Transform.prototype = {
  ...
  translate: function (x4, y4) {
    return (x4 === 0) & (y4 === 0)
      ? this
      : new Transform(this.k, this.x + this.k * x4, this.y + this.k * y4);
  },
  ...
  rescaleX: function (x4) {
    return x4
      .copy()
      .domain(x4.range().map(this.invertX, this).map(x4.invert, x4));
  },
  rescaleY: function (y4) {
    return y4
      .copy()
      .domain(y4.range().map(this.invertY, this).map(y4.invert, y4));
  },
  toString: function () {
...
function defaultWheelDelta(event) {
  return (
    -event.deltaY *
    (event.deltaMode === 1 ? 0.05 : event.deltaMode ? 1 : 2e-3) *
    (event.ctrlKey ? 10 : 1)
  );
}
...
function defaultConstrain(transform2, extent2, translateExtent) {
  var dx0 = transform2.invertX(extent2[0][0]) - translateExtent[0][0],
    dx1 = transform2.invertX(extent2[1][0]) - translateExtent[1][0],
    dy0 = transform2.invertY(extent2[0][1]) - translateExtent[0][1],
    dy1 = transform2.invertY(extent2[1][1]) - translateExtent[1][1];
...
function zoom_default2() {
  ...
  zoom.scaleTo = function (selection2, k2, p, event) {
    zoom.transform(
      selection2,
      function () {
        var e = extent2.apply(this, arguments),
          t03 = this.__zoom,
          p02 =
            p == null
              ? centroid(e)
          ...
          k1 = typeof k2 === "function" ? k2.apply(this, arguments) : k2;
        return constrain(
          translate(scale2(t03, k1), p02, p1),
          e,
          translateExtent,
        );
      },
  ...
  function scale2(transform2, k2) {
    ...
    return k2 === transform2.k
      ? transform2
      : new Transform(k2, transform2.x, transform2.y);
  }
  function translate(transform2, p02, p1) {
    var x4 = p02[0] - p1[0] * transform2.k,
      y4 = p02[1] - p1[1] * transform2.k;
    return x4 === transform2.x && y4 === transform2.y
      ? transform2
      : new Transform(transform2.k, x4, y4);
  }
    ...
    transition2
      ...
      .tween("zoom", function () {
        var that = this,
          ...
          e = extent2.apply(that, args),
          p =
            point6 == null
              ? centroid(e)
              : typeof point6 === "function"
                ? point6.apply(that, args)
                : point6,
  ...
  function wheeled(event, ...args) {
    ...
    g.zoom(
      "mouse",
      constrain(
        translate(scale2(t, k2), g.mouse[0], g.mouse[1]),
        g.extent,
        translateExtent,
      ),
    );
    ...
    function mousemoved(event2) {
      ...
      g.event(event2).zoom(
        ...
        constrain(
          translate(
            g.that.__zoom,
            (g.mouse[0] = pointer_default(event2, currentTarget)),
            g.mouse[1],
          ),
          g.extent,
          translateExtent,
  ...
  zoom.wheelDelta = function (_) {
    return arguments.length
      ? ((wheelDelta = typeof _ === "function" ? _ : constant_default11(+_)),
        zoom)
      : wheelDelta;
  };
  zoom.filter = function (_) {
    return arguments.length
      ? ((filter3 = typeof _ === "function" ? _ : constant_default11(!!_)),
        zoom)
      : filter3;
  };
  zoom.touchable = function (_) {
    return arguments.length
      ? ((touchable = typeof _ === "function" ? _ : constant_default11(!!_)),
        zoom)
      : touchable;
  };
